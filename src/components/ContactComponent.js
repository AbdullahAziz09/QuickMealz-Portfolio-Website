...
const ContactComponent = () => {
  return (
    <div className="min-h-screen flex justify-center items-center bg-gradient-to-b from-blue-100 to-blue-300 p-0">
      <div className="w-full max-w-4xl bg-white shadow-lg rounded-lg overflow-hidden flex flex-col sm:flex-row">
        ...
        <div className="flex flex-col justify-center items-start p-8 bg-blue-50 sm:w-2/3">
          <h2 className="text-3xl font-bold text-blue-800 mb-3">Our Company</h2>
          <p className="text-gray-600 mb-4">Delivering exceptional service since 2000.</p>
          <div className="mb-4">
            <p className="text-gray-700 font-medium">Contact Number:</p>
            <p className="text-blue-600 font-semibold text-lg">+92 300 1234567</p>
          </div>
          <div className="mb-4">
            <p className="text-gray-700 font-medium">Email:</p>
            <p className="text-blue-600 font-semibold text-lg">info@company.com</p>
          </div>
          <div>
            <p className="text-gray-700 font-medium">Address:</p>
            <p className="text-blue-600 font-semibold text-lg">1234 Main St, City, Country</p>
          </div>
        </div>

        {/* Right Card: WhatsApp Button */}
        <div className="flex justify-center items-center bg-gradient-to-br from-green-400 to-blue-500 sm:w-1/3 p-8 relative group">
          <a
